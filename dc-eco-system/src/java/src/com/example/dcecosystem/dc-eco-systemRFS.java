package com.example.dcecosystem;

import com.example.dcecosystem.namespaces.*;
...
public class dc-eco-systemRFS {
    ...
    @ServiceCallback(servicePoint="dc-eco-system-servicepoint",
     ...
     */
    @ActionCallback(callPoint="dc-eco-system-self-test", callType=ActionCBType.INIT)
     ...
     */
    @ActionCallback(callPoint="dc-eco-system-self-test", callType=ActionCBType.ACTION)
    public ConfXMLParam[] selftest(DpActionTrans trans, ConfTag name,
                                   ConfObject[] kp, ConfXMLParam[] params)
    throws DpCallbackException {
        try {
            // Refer to the service yang model prefix
            String nsPrefix = "dc-eco-system";
